		...
		public void mouseReleased(MouseEvent mouseEvent) {
			...
			if (SwingUtilities.isRightMouseButton(mouseEvent)) {
				...
				String value = JOptionPane.showInputDialog(null,
						"Enter Cell Value:");
				if (value != null) { // If they entered info, update the
										// database
					...
					// updateColumn =
					// Customer.db.defaultTableModel.getColumnName(table.getSelectedColumn());
					//
					// switch(updateColumn) {
					// // if the column was date_registered, convert date update
					// using a Date
					// case "Date_Registered":
					// sqlDateRegistered = getADate(value);
					// Customer.db.rows.updateDate(updateColumn, (Date)
					// sqlDateRegistered);
					...
					// break;
					// }
					// } catch (SQLException e1) { // Catch any exceptions and
					// display an error
