...
class CustomTablePanel<TableModelClass, TableObjectClass> extends JPanel {
	...
	CustomTablePanel(String label , TableObjectClass tableObject, TableModelClass tableModel) {
		super();
		mTable = new CustomJTable<TableModelClass, TableObjectClass>(tableObject, tableModel);
