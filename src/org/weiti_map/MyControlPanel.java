...
public class MyControlPanel extends JPanel {
	...
	private JLabel tableTypeLabel = new JLabel("wybierz grupę");
	private JButton printJButton = new JButton("Pokaż");
	
	private JRadioButton showDataRadioButton = new JRadioButton("wyświetlanie danych");
	private JRadioButton insertRadioButton = new JRadioButton("wprowadzanie danych");

	private String[] mainViewColNames = { "Plan zajęć", "Zajęcia", "Pracownicy", "Sale" };
    ...
    private void configure() {  	
		...
		/*
		 *  czy korzystać z metod klasy zewnętrznej w actionlistenerze?
		 * 
		 */
			...
			public void actionPerformed(ActionEvent e) {
				...
				switch (comboBox1String) {
					case "Plan zajęć":
						...
						tableTypeLabel.setText("wybierz grupę");						
						break;
					case "Zajęcia":
